...
export default function Disclaimer() {
  return (
    <PageShell title="Disclaimer" showBack backHref="/">
      <Card padding="lg">
        <h1 className="text-3xl font-bold text-ink mb-8">Disclaimer</h1>
        <div className="space-y-6 text-ink/70 leading-relaxed">
          <div>
            <h2 className="font-bold text-ink text-lg mb-2">Alat Bantu, Bukan Konseling</h2>
          ...
          <div>
            <h2 className="font-bold text-ink text-lg mb-2">Akurasi Data</h2>
          ...
          <div>
            <h2 className="font-bold text-ink text-lg mb-2">Keputusan Pengguna</h2>
          ...
          <div>
            <h2 className="font-bold text-ink text-lg mb-2">AI Generated</h2>
            <p>Beberapa konten dihasilkan oleh AI (Google Gemini). Verifikasi informasi penting dengan sumber resmi.</p>
          </div>
          <div>
            <h2 className="font-bold text-ink text-lg mb-2">Testimonial</h2>
