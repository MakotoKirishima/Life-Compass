  ...
  return (
    <div className="fixed bottom-0 right-0 left-0 md:bottom-6 md:right-6 md:left-auto md:max-w-md z-50 bg-card border-2 border-ink rounded-t-2xl md:rounded-2xl shadow-2xl p-6 m-0 md:m-4 animate-in slide-in-from-bottom-4 duration-300">
      ...
      <div className="flex flex-col md:flex-row gap-2">
        <button
          onClick={dismiss}
          className="bg-ink text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-ink/90 transition active:scale-[0.98]"
        >
          Lanjutkan
        </button>
      </div>
      <a href="/privacy" className="text-xs text-ink/50 hover:text-ink underline mt-3 inline-block">
        Kebijakan Privasi
      </a>
    </div>
  );
